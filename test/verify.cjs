...
(async () => {
  ...
  check('buyer: tip modal shows empty bowl before tip', await page.locator('#modalRoot img[src="assets/tip-mascot-empty-real.png"]').count() === 1);
  ...
  check('buyer: coins image appears after tip', await page.locator('.tip-list-head img[src="assets/tip-mascot-full-real.png"]').count() >= 1);
  ...
  check('buyer: sea shipment scene shown', await page.locator('.transport-scene[src*="transport-sea"]').count() >= 1);
