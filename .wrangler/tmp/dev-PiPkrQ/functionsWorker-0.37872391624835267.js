...
// .wrangler/tmp/pages-5dPiqL/functionsWorker-0.37872391624835267.mjs
...
__name2(configureAuth, "configureAuth");
...
__name2(antiFakeCode, "antiFakeCode");
...
__name2(seedIfEmpty, "seedIfEmpty");
...
__name2(providerMode, "providerMode");
...
__name2(fetchTimeout, "fetchTimeout");
...
__name2(providerMyMemory, "providerMyMemory");
...
__name2(providerLibre, "providerLibre");
...
__name2(providerDeepL, "providerDeepL");
...
__name2(offlineTranslate, "offlineTranslate");
function todayKey() {
...
__name2(translateError, "translateError");
...
__name2(asBytes, "asBytes");
function magicMatches(mime, bytes) {
  if (mime === "image/webp") {
    if (bytes.length <= 12) return false;
    const tag = /* @__PURE__ */ __name2((o) => String.fromCharCode(bytes[o], bytes[o + 1], bytes[o + 2], bytes[o + 3]), "tag");
...
__name2(magicMatches, "magicMatches");
...
__name2(validateFile, "validateFile");
var transport = null;
...
__name2(configureMailer, "configureMailer");
...
function createApp({ env: env2 = {}, deps = {} } = {}) {
  ...
  __name2(refreshNewsFeeds, "refreshNewsFeeds");
  ...
  __name2(startNewsAutoRefresh, "startNewsAutoRefresh");
  ...
  __name2(ensureInsuranceProviders, "ensureInsuranceProviders");
  ...
  __name2(loginRateLimit, "loginRateLimit");
  ...
  __name2(registerRateLimit, "registerRateLimit");
  ...
  __name2(newEmailToken, "newEmailToken");
  ...
  __name2(sendVerifyEmail, "sendVerifyEmail");
  ...
  __name2(readRawBody, "readRawBody");
  ...
  __name2(parseMultipart, "parseMultipart");
  ...
  __name2(productView, "productView");
  ...
  __name2(shipmentView, "shipmentView");
  ...
  __name2(evidencePayload, "evidencePayload");
  ...
  __name2(lastEvidence, "lastEvidence");
  ...
  __name2(addEvidence, "addEvidence");
  ...
  __name2(verifyEvidenceChain, "verifyEvidenceChain");
  ...
  __name2(watermarkSvg, "watermarkSvg");
...
function makeD1Store(DB) {
  const clean = /* @__PURE__ */ __name2((params) => params.map((v) => {
...
__name2(makeD1Store, "makeD1Store");
...
__name2(makeR2Storage, "makeR2Storage");
function makeDisabledStorage() {
  const fail = /* @__PURE__ */ __name2(() => {
    throw new Error("\u6587\u4EF6\u5B58\u50A8\u672A\u914D\u7F6E\uFF08\u8BF7\u5728 wrangler.jsonc \u7ED1\u5B9A R2 \u6876\uFF09");
  }, "fail");
  return { put: fail, get: /* @__PURE__ */ __name2(async () => null, "get"), del: /* @__PURE__ */ __name2(async () => false, "del") };
}
__name(makeDisabledStorage, "makeDisabledStorage");
__name2(makeDisabledStorage, "makeDisabledStorage");
var appPromise = null;
...
__name2(mailTransport, "mailTransport");
async function onRequest(context2) {
  ...
  const bodyBuffer = /* @__PURE__ */ __name2(() => bodyPromise || (bodyPromise = request.arrayBuffer().then((b) => new Uint8Array(b))), "bodyBuffer");
  const req = {
    ...
    text: /* @__PURE__ */ __name2(() => bodyBuffer().then((b) => new TextDecoder().decode(b)), "text")
  };
  const res = {
    status: 200,
    headers: {},
  ...
  await app.handle({
    ...
    req: hasBody ? req : { ...req, text: /* @__PURE__ */ __name2(async () => "", "text"), arrayBuffer: /* @__PURE__ */ __name2(async () => new Uint8Array(0), "arrayBuffer") },
    res
  });
  const out = res.body;
...
// .wrangler/tmp/bundle-E1o1lg/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-E1o1lg/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.37872391624835267.js.map
